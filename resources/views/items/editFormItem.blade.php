...
@section('content')
<h1 class="text-center p-2">Editar Item</h1>
    ...
    <form action="{{ route('items.update', $item->id) }}" method="POST">
        ...
        <div class="p-5">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="itemDescription" name="itemDescription" required>{{$item->itemDescription}}</textarea>
            </div>
            <div class="mb-3">
                <label for="itemPrice" class="form-label">Precio del Item:</label>
                <input type="number" class="form-control" id="itemPrice" name="itemPrice" value="{{$item -> itemPrice}}" required>
            </div>
